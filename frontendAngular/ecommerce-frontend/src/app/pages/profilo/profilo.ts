...
export class Profilo implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.utente.ruolo === 'CLIENTE' && this.utente.id) {
      ...
      this.clienteService.getClienti().subscribe(clienti => {
        ...
        this.cliente = clienti.find(c => c.utente.id === this.utente?.id);
    ...
    if (this.utente.ruolo === 'VENDITORE' && this.utente.id) {
      ...
      this.venditoreService.getVenditori().subscribe(venditori => {

        this.venditore = venditori.find(v => v.utente.id === this.utente?.id);
  ...
  salvaVenditore(): void {
    ...
    this.venditoreService.modificaVenditore(
      this.venditore.id,
