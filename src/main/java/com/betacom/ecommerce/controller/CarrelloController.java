...
public class CarrelloController {
    ...
    public List<CarrelloProdotto> getProdottiCarrello(
            @PathVariable Integer idCarrello) {

        return carrelloProdottoRepository.findByCarrelloId(idCarrello);
    ...
    public CarrelloProdotto aggiungiAlCarrello(@RequestBody CarrelloProdotto cp) {
        ...
        Optional<CarrelloProdotto> esistente = carrelloProdottoRepository.findAll()
                .stream()
                .filter(prodotto -> prodotto.getCarrello().getId()
    ...
    public CarrelloProdotto aggiornaQuantita(
        ...
        CarrelloProdotto cp = carrelloProdottoRepository.findById(id)
                .orElse(null);
